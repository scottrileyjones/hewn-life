...
export default function About() {
  return (
    <>
      {/* Hero */}
      <section className="bg-obsidian min-h-[70vh] flex items-end pb-24 relative overflow-hidden grain-overlay pt-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <h1 className="font-display font-light italic text-[56px] md:text-[72px] leading-[1.08] text-cream max-w-4xl mb-8 animate-fade-up delay-1">
            We believe marketing is the life of your business — not an afterthought.
          </h1>
