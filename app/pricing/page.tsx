...
export default function Pricing() {
  ...
  return (
    <>
      {/* Hero — unchanged */}
      <section
        className="flex items-start md:items-end pt-20 md:pt-40 pb-16 md:pb-24 relative overflow-hidden"
      ...
      <section id="plans" ref={plansRef} className="bg-bone py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-14">
            ...
            <h2 className="font-display font-semibold fluid-h2 text-ink mt-5 mb-3">Three tiers. No contracts. No agency tax.</h2>
                        ...
                        {annual ? (
                          <>
                            ...
                            <div className="flex items-end gap-1">
                              <span className={`font-display font-bold fluid-stat leading-none ${isFeatured ? 'text-white' : 'text-ink'}`}>${price.toLocaleString()}</span>
      ...
      <section className="bg-moss py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-12">
            ...
            <h2 className="font-display font-semibold fluid-h2 text-cream mb-3">Just need one thing?</h2>
      ...
      {/* Agency Tax table */}
      <section className="bg-bone py-16 md:py-24 border-t border-black/[0.06]">
        <div className="max-w-3xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-10">
            <SectionEyebrow text="The Agency Tax" light />
            <h2 className="font-display font-semibold text-[32px] text-ink mt-4 mb-2">What you&apos;re really paying for</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
      ...
      <section className="bg-obsidian py-24 md:py-32">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display font-bold fluid-h2 leading-tight text-cream mb-6">
          ...
          <p className="font-body text-base text-ash max-w-lg mx-auto mb-10">
            Book a free 30-minute discovery call. No pitch deck, no pressure — just an honest conversation about your business and where to start.
          </p>
