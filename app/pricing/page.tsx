...
const tiers = [
  {
    ...
    tagline: 'Brand, website, and presence — built and actively managed.',
    price: { monthly: 2500, annual: 2250 },
    accentColor: '#B87A40',
    badge: null as string | null,
    highlights: [
      'Brand identity, website & Google setup',
      'Organic social — 3 posts/week across 2 platforms',
      'Google Business Profile management',
      'Monthly SEO content + AI market intelligence',
      'Monthly strategy call',
    ],
    deliverables: [
      {
        pillar: 'Build (Month 1–2)',
        items: [
          'Brand Strategy (positioning, audience, voice)',
      ...
      {
        pillar: 'Ongoing Management (Month 3+)',
        items: [
          'Organic social — 3 posts/week, 2 platforms (AI-assisted)',
          'Google Business Profile (posts, review responses, Q&A)',
          '1 SEO blog post per month',
          'Monthly AI competitor & market intelligence brief',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Lifecycle marketing — email & SMS (Klaviyo, Customer.io)',
      'Sales funnels, CRM & automation',
      'Monthly paid media performance report',
    ],
    deliverables: [
      {
        pillar: 'Everything in Hewn',
        items: ['All Hewn build deliverables + ongoing management included'],
      },
      {
        pillar: 'Paid Media (ongoing)',
        items: [
          'Google Ads management (search, display, retargeting)',
          'Meta Ads management (Facebook + Instagram)',
          'A/B creative testing + continuous optimization',
          'Monthly paid media performance report',
        ],
      },
      {
        pillar: 'Lifecycle Marketing — Email & SMS (ongoing)',
        items: [
          'Platform setup (Klaviyo, Customer.io, or your stack)',
          'Onboarding, nurture & re-engagement sequences',
          'Monthly email campaigns + A/B subject line testing',
          'List management & segmentation',
        ],
      },
      {
        pillar: 'Funnels & Systems (build)',
        items: [
          'Sales funnel design (landing pages, offers, conversion paths)',
          'CRM setup & pipeline integration',
          'Booking & scheduling system',
          'Monthly funnel optimization sprint',
        ],
      },
    ],
  },
  {
    ...
    highlights: [
      ...
      'TikTok ads + full social media management',
      'Advanced lifecycle — SMS, behavioral triggers & win-back',
      'UGC campaigns + referral program',
      'Fractional CMO + quarterly growth planning',
    ],
    deliverables: [
      {
        pillar: 'Everything in Forged',
        items: ['All Forged build deliverables + ongoing management included'],
      },
      {
        pillar: 'TikTok & Full Social (ongoing)',
        items: [
          'TikTok ad management (campaigns, creative, optimization)',
          'Full social media management — all platforms, daily content',
          'UGC strategy & campaign execution',
          'Influencer outreach coordination',
        ],
      },
      {
        pillar: 'Advanced Lifecycle Marketing (ongoing)',
        items: [
          'SMS campaigns (promotional + behavioral)',
          'Advanced segmentation & behavioral triggers',
          'Win-back & purchase milestone automations',
          'Lifecycle performance reporting',
        ],
      },
      {
        pillar: 'Reputation & Advisory',
        items: [
          'Review generation system',
          'Referral program with tracking',
          'Monthly KPI dashboard',
          'Quarterly growth planning sessions',
          'Fractional CMO (weekly check-ins + strategic direction)',
        ],
      },
    ],
  },
