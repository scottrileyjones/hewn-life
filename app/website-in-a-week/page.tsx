      ...
      <section className="pt-36 pb-20 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="animate-fade-up max-w-3xl">
            ...
            <h1 className="hero-heading text-[44px] md:text-[64px] text-[#0D0D0D] mb-6 leading-[1.04]">
              A real website.<br />
              <span className="accent" style={{ color: '#8B5CF6' }}>In one week. $1,000.</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="text-center md:text-left">
              ...
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#A78BFA]">{s.label}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 max-w-2xl">
            ...
            <h2 className="hero-heading text-[36px] md:text-[52px] text-[#0D0D0D] leading-tight mt-3">
              ...
              <span className="accent" style={{ color: '#8B5CF6' }}>Day by day.</span>
            </h2>
      ...
      <section className="bg-[#F9F7F3] py-24 md:py-32 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_1.2fr] gap-16 items-start">
          <div>
            ...
            <h2 className="hero-heading text-[36px] md:text-[48px] text-[#0D0D0D] leading-tight mt-3 mb-5">
              Everything you need<br />
              <span className="accent" style={{ color: '#8B5CF6' }}>to go live.</span>
            </h2>
          ...
          <ul className="grid sm:grid-cols-2 gap-px bg-black/[0.08] border border-black/[0.08]">
            {included.map(item => (
              <li key={item} className="bg-[#F9F7F3] p-6 flex items-start gap-3">
                <span className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full bg-[#8B5CF6] flex items-center justify-center">
      ...
      <section className="bg-white py-24 md:py-32 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto">
          <div className="mb-14">
            ...
            <h2 className="hero-heading text-[36px] md:text-[48px] text-[#0D0D0D] leading-tight mt-3">
              The honest answers.
            </h2>
          </div>
