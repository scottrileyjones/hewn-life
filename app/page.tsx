    ...
    <>
      ...
      <section className="bg-obsidian min-h-screen flex flex-col items-center justify-center text-center relative overflow-hidden grain-overlay pt-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up delay-3">
            <Link href="/contact" className="bg-copper text-obsidian font-body font-medium px-8 py-4 rounded-full hover:brightness-110 hover:scale-[1.02] transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left">
              <p className="font-display font-bold text-[120px] leading-none text-copper">3x</p>
            ...
            <div>
              ...
              <Link href="/pricing" className="font-body text-sm text-copper hover:underline underline-offset-4">
                See How We Price It →
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {pillars.map((pillar) => (
              <div
                key={pillar.num}
                className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8 hover:border-copper/30 hover:-translate-y-0.5 transition-all duration-300"
              >
                <p className="font-display font-bold text-[48px] text-copper/20 leading-none mb-4">{pillar.num}</p>
      ...
      <section className="bg-stone py-24 md:py-32">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          <p className="font-display text-[80px] leading-none text-copper/20 mb-4">&ldquo;</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/[0.08]">
                  ...
                  <th className="text-left py-4 font-body text-[11px] uppercase tracking-[0.1em] text-copper font-normal">Hewn Life Gold</th>
                </tr>
              </thead>
              <tbody>
                {comparisonRows.map((row, i) => (
                  <tr key={i} className="border-b border-white/[0.08]">
                    ...
                    <td className="py-4 font-body text-sm text-copper">{row.hewn}</td>
                  </tr>
                ))}
              </tbody>
              <tfoot>
                <tr className="border-t-2 border-copper/30">
                  ...
                  <td className="py-6 font-body font-semibold text-sm text-copper">$9,500/month</td>
                </tr>
              </tfoot>
            </table>
          </div>
