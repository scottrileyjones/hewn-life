    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            type="text"
            required
            className="w-full border border-black/10 rounded-xl px-4 py-3 font-body text-sm text-ink bg-white focus:border-copper focus:outline-none focus:ring-1 focus:ring-copper transition-all"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <select className="w-full border border-black/10 rounded-xl px-4 py-3 font-body text-sm text-ink bg-white focus:border-copper focus:outline-none focus:ring-1 focus:ring-copper transition-all">
      ...
      <div>
        ...
        <textarea
          required
          rows={4}
          className="w-full border border-black/10 rounded-xl px-4 py-3 font-body text-sm text-ink bg-white focus:border-copper focus:outline-none focus:ring-1 focus:ring-copper transition-all resize-none"
      ...
      <button
        type="submit"
        className="w-full bg-copper text-obsidian font-body font-medium py-4 rounded-full hover:brightness-110 hover:scale-[1.01] transition-all duration-300"
      >
